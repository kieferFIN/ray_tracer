...
fn main() {
    ...
    let ball = Ball{c:rt::Color{r:1.0, g:0.0,b:0.0},r:2.0, o: rt::Vector::new(1.0, 0.0, -7.0)};
    let ball2 = Ball{c:rt::Color{r:0.0,b:1.0,g:0.0},r:2.0, o: rt::Vector::new(-0.5, 0.0, -8.0)};
